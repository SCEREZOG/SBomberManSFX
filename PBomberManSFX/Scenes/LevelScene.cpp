...
{
    auto metal = std::make_shared<Sprite>(gameManager->getAssetManager()->getTexture(Texture::Metal_Cartoon),
...
{
    auto grass = std::make_shared<Sprite>(gameManager->getAssetManager()->getTexture(Texture::Grass_Cartoon),
                                            gameManager->getRenderer());
...
{
    auto brick = std::make_shared<Sprite>(gameManager->getAssetManager()->getTexture(Texture::Brick_Cartoon),
                                            gameManager->getRenderer());
...
{
    auto stone = std::make_shared<Sprite>(gameManager->getAssetManager()->getTexture(Texture::Stone_Cartoon),
                                            gameManager->getRenderer());
...
void LevelScene::generateEnemies()
{
    ...
    for(int i = 0; i < randCount(); i++)
    {
        ...
        spawnEnemy(textureRand == 0 ? Texture::Enemy1_Cartoon :
                                        (textureRand == 1 ? Texture::Enemy2_Cartoon : Texture::Enemy3_Cartoon),
...
void LevelScene::spawnBomb(GameGraphicObject* object)
{
    ...
    bomb =
        std::make_shared<Sprite>(gameManager->getAssetManager()->getTexture(Texture::Bomb_Cartoon), gameManager->getRenderer());
...
void LevelScene::spawnBang(GameGraphicObject* object)
{
    ...
    {
        auto bang = std::make_shared<Sprite>(gameManager->getAssetManager()->getTexture(Texture::Explosion_Cartoon),
                                                gameManager->getRenderer());
...
void LevelScene::spawnDoor(GameGraphicObject* object)
{
    ...
    door =
        std::make_shared<Sprite>(gameManager->getAssetManager()->getTexture(Texture::Door_Cartoon), gameManager->getRenderer());
